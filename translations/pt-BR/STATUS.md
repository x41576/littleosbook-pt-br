...
- `syscalls`: o link para a seção "Further Reading" aponta para `#further-reading-7`, que é a seção de *Page Frame Allocation*; deveria ser `#further-reading-10`. A tradução usa `#further-reading-10`; o `validar.py` aceita a troca (`LINKS_CORRIGIDOS`).
